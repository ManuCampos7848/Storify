...
public class ListaCancionesPorAtributoController{
	...
	//	MenuUsuarioController accesoCanciones = new MenuUsuarioController();
	...
	void volverEvent(ActionEvent event) {
		...
		acceso.getListaCancionesPorAtributo().clear();
	...
	/*
	 * Metodo que permite cargar la lista de canciones dado un atributo
	 */
	public void init() {
		...
		for (int i = 0; i < acceso.getListaCancionesPorAtributo().size();i++) {
			//
			String nombre = acceso.getListaCancionesPorAtributo().get(i).getNombre();
			String codigo = acceso.getListaCancionesPorAtributo().get(i).getCodigo();
			String album = acceso.getListaCancionesPorAtributo().get(i).getAlbum();
			String caratula = acceso.getListaCancionesPorAtributo().get(i).getCaratula();
			String anio = acceso.getListaCancionesPorAtributo().get(i).getAnio();
			double duracion = acceso.getListaCancionesPorAtributo().get(i).getDuracion();
			String genero = acceso.getListaCancionesPorAtributo().get(i).getGenero();
			String url = acceso.getListaCancionesPorAtributo().get(i).getUrl();
			File archivo = acceso.getListaCancionesPorAtributo().get(i).getArchivo();
