...
public class ListaArtistasPorAtributoController implements Initializable{
	...
	void verListaCancionesArtista(ActionEvent event) {
		...
		if(artistaSeleccionado == null) {
			...
			try {
				...
				stage.setTitle("Ver Canciones del Artista");
	...
	void volverEvent(ActionEvent event) {
		...
		acceso.getListaArtistasPorAtributo().clear();
