...
public class ReproducirCancionAdmin implements Initializable{

	// Atributo que permite identificar esa canción en especifico
	private Cancion cancion = MetodosUsuario.obtenerCancionAdmin();
...
//    private File[] files;
  ...
  //____________________________________________________________________________________________________________________________
	...
	/*
	 * El método init() se encarga de inicializar la etiqueta de la canción (songLabel) con el nombre de la canción en letras mayúsculas, 
	 * obtenido a partir del objeto cancion que parece ser una instancia de alguna clase que contiene información de la canción.
	 */
	public void init() {
		songLabel.setText(cancion.getNombre().toUpperCase());
	}
	//____________________________________________________________________________________________________________________________
