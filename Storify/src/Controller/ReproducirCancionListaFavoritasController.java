...
public class ReproducirCancionListaFavoritasController implements Initializable{

	// Atrbuto que permite saber cual usuario es del que se habla
	...
	// Lista que añade las canciones del usuario 
	ArrayList<Cancion> todasLasCanciones = usuario.getCancionesFavoritas();
	//____________________________________________________________________________________________________________________________
